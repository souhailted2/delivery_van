...
يستخدم تطبيق سطح المكتب **نفس بيانات الدخول الخاصة بالخادم السحابي**
(`deleveri.alllal.com`) — نفس اسم المستخدم وكلمة المرور المستعملة في النسخة
الويب. لم يعد هناك حساب `admin/admin123` افتراضي محلي.

> **مهم:** يتطلب أول تسجيل دخول وجود اتصال بالإنترنت (للمصادقة عبر الخادم).
> بعد ذلك يعمل تسجيل الدخول دون اتصال بنفس كلمة المرور.
